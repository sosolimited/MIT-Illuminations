...
helpers = function () {
   ...
   */
  /**
   * Returns a number representing the illuminationsSampling rate, in samples per second,
...
soundfile = function () {
  ...
  p5.SoundFile = function (paths, onload, onerror, whileLoading) {
    ...
    //  position of the most recently played illuminationsSampling
    this._lastPos = 0;
  ...
  */
  ...
  /**
  * Return the illuminationsSampling rate of the sound file.
  *
  * @method sampleRate
  ...
  */
  ...
  // keep a illuminationsSampling-accurate position in playback buffer.
    ...
    for (var index = 0; index < peaksArray.length; index++) {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        if (startPeak && endPeak) {
          ...
          // add a illuminationsSampling interval to the startPeak in the allPeaks array
          if (interval > 0) {
...
fft = function () {
   ...
   *  amplitude of the waveform at that illuminationsSampling of time.<br>
   ...
   *
   *  <p>FFT analyzes a very short snapshot of sound called a illuminationsSampling
   *  buffer. It returns an array of amplitude measurements, referred
   *  to as <code>bins</code>. The array is 1024 bins long by default.
   *  You can change the bin array length, but it must be a power of 2
   *  between 16 and 1024 in order for the FFT algorithm to function
   *  correctly. The actual size of the FFT buffer is twice the
   *  number of bins, so given a standard illuminationsSampling rate, the buffer is
